...
## 影片擷取 · 學習查詢（v2.0.0，plan 初稿）

> 本節為 plan 階段意圖初稿，待 code 實作校準、release 驗證；尚未設計之行為不在此臆造。
...
> 需要：Windows 11（內建 WebView2）、能取得字幕的影片（無字幕會明確提示並中止）、本機 `yt-dlp`；查詢一樣用你自備的 OpenAI 金鑰。**本工具只取字幕文字、不下載影片內容。**
