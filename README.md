...
- **依人套主題色**：清單裡每個名字，**用他在字幕裡的顏色顯示**（和字幕帶上該說話人的字型色同一來源）——清單看到的顏色，就是字幕上那個人的顏色，一眼對得起來。沒有配到主題色的說話人（主題色的色彩描述沒點到這個名字）維持預設色，和字幕行為一致。清單是小字白底，若某人的主題色**太淺**（如亮黃）會**自動壓深一點**以保名字讀得清楚（同一種顏色、只是加深到看得見）。
...
![影片頁說話人勾選面板：各名字依主題色顯示（比照字幕帶上色）、並依語句數由多到少排序（(全部說話人) 置頂、(無說話人) 置底）](docs/manual-assets/video-speaker-color-sort.png)
